        ...
        <div class='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4'>
            ...
            <div class="h-[400px] sm:h-[540px] bg-[url('./imgs/favicon/Chanh_Da_Xay.png')] bg-cover bg-no-repeat bg-center">
              <a href='#' alt='#'>
                <div class='w-full h-full hover:bg-gray-900 hover:opacity-10 hover:transition-all hover:ease-in-out hover:duration-400 relative group:'>
                  <div class='absolute bg-slate-100 text-gray-900 w-11/12 bottom-4 left-1/2 -translate-x-1/2 group-hover:block group-hover:animate-fadeIn nvd-button'>
                    Đặt ngay
                  </div>
                </div>
              </a>
          ...
          <div class='nvd-product-card '>
            <div class="h-[400px] sm:h-[540px] bg-[url('./imgs/favicon/Tra_Oi_Hong.png')] bg-cover bg-no-repeat bg-center">
              <a href='#' alt='#'>
                <div class='w-full h-full hover:bg-gray-900 hover:opacity-10 hover:transition-all hover:ease-in-out hover:duration-400 relative group:'>
                  <div class='absolute w-[100px] bg-white py-2 px-4 top-3 right-3 text-center font-semibold text-coffee-400'>
                    {' '}
                    On sale.
                  </div>
                  <div class='absolute bg-slate-100 text-gray-900 w-11/12 bottom-4 left-1/2 -translate-x-1/2 group-hsover:block group-hover:animate-fadeIn nvd-button'>
                    Đặt ngay
                  </div>
                </div>
              </a>
